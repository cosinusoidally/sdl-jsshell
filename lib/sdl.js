...
frame timer will be generated by SDL used to periodically wake up our mainloop
to draw a frame (since jsshell does not have setInterval or setTimout (it does
have Date.now, but that means we would need to poll to measure time, which is
inefficient (yes I know nested parentheticals in writing are bad))).
