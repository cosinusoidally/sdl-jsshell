...
v0.0.2/ similar to v0.0.1 but this version supports multiple architectures
(win32, linux-i686 and linux-x86_64). This version was retired when I learnt
about issues with timers and the latency of SDL_WaitEvent. The current version
in ../lib does not suffer from that issue.
